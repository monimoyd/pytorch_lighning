...
# Adding 4 new arguments accumulate_grad_batches, precision, overfit_batches, progress_bar_refresh_rate
...
parser.add_argument("--overfit_batches", default=5, type=int, help="Overfit Batches")

parser.add_argument("--progress_bar_refresh_rate", default=2, type=int, help="Progress Bar Refresh Rate")
...
# Adding 4 new lighnting features accumulate_grad_batches, precision, overfit_batches, progress_bar_refresh_rate
trainer_args = {
    "logger": tboard,
